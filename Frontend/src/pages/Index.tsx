...
export default function Index() {
  ...
  async function fetchDashboardData() {
    ...
    // Supabase removal ke baad full dashboard migration baaki hai.
    // Abhi safe defaults set kar dete hain taaki UI crash na ho.
    setClassAttendance({});
    setStats({
      attendance: "0%",
    ...
    setWeeklyData(days.map((d) => ({ day: d, hours: 0 })));
    setSprintTasks([]);
  }
